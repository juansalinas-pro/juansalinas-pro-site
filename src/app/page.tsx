        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 space-y-8 text-gray-500 dark:text-gray-300">
              ...
              <p>
                Born on May 9th, 1988 in the beautiful city of <Link href="https://en.wikipedia.org/wiki/Buenos_Aires" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400" target="_blank" rel="noopener noreferrer">Buenos Aires</Link> (Capital City of <Link href="https://en.wikipedia.org/wiki/Argentina" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400" target="_blank" rel="noopener noreferrer">Argentina</Link>).
              </p>

              <p>
                My journey in Software Engineering began while working at the <Link href="https://en.wikipedia.org/wiki/Bank_of_the_Province_of_Buenos_Aires" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400" target="_blank" rel="noopener noreferrer">Bank of the Province of Buenos Aires</Link>. From 2010 to 2012, I was part of a dedicated team responsible for implementing a lending management system. This project ignited my passion for software development, as I gained hands-on experience in managing complex processes, collaborating closely with the project leader, and delivering solutions that improved the bank's operational efficiency.
              </p>

              <p>
                From 2013 to 2019, I built software for <Link href="https://en.wikipedia.org/wiki/Buquebus" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400" target="_blank" rel="noopener noreferrer">Buquebus</Link> e-commerce, where I started my path in the tourism industry. At Buquebus, I started as a Junior Full Stack Developer, and as I gained more experience I started to get more responsibilities. After 4 years, I became a Technical Lead of a team of 5 members, managing the team and resources for delivering software solutions for the Buquebus e-commerce, and I did it pretty well based on feedbacks I got from my coordinators.
              </p>

              <p>
                In November 2019, I began to feel a restlessness of working in huge projects of digital transformation with cloud computing, so I started to build software for <Link href="https://en.wikipedia.org/wiki/Equifax" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400" target="_blank" rel="noopener noreferrer">Equifax</Link>. It was a project of an entire migration of the legacy platform to cloud computing (GCP).
              </p>

              <p>
                After getting my Bachelor's Degree from <Link href="https://maps.app.goo.gl/rApWSPXMdDqxtfMy8" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400" target="_blank" rel="noopener noreferrer">UNLZ</Link>, I wanted to work in startups, where I can build more scalable and innovative software solutions with cutting-edge technologies.
              </p>

              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mt-12">Journey (2021 - present)</h3>

              <p>
                Since 2021, I've been building software in startups that are scalable, innovative with cutting-edge technologies. My path has been through <Link href="https://almundo.com.ar/" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400" target="_blank" rel="noopener noreferrer">Almundo</Link>, <Link href="https://www.tul.io/" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400" target="_blank" rel="noopener noreferrer">TUL</Link>, and currently <Link href="https://travelx.io/" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400" target="_blank" rel="noopener noreferrer">TravelX</Link>.
              </p>

              <p>
                In 2023, I presented <Link href="https://greenplus.gitbook.io/greenplus" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400" target="_blank" rel="noopener noreferrer">Green Plus</Link>, a startup idea in <Link href="https://startuplab.pol.una.py/" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400" target="_blank" rel="noopener noreferrer">Startup Lab</Link>, an incubation program. Green Plus, a SaaS for managing companies' carbon footprint, using blockchain (<Link href="https://algorand.co/" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400" target="_blank" rel="noopener noreferrer">Algorand</Link>) and machine learning as its core solution. During this program I learned a lot more about the startup ecosystem, but I didn't execute the idea because I didn't find the idea motivational enough.
              </p>
